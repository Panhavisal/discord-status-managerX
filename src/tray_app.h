...
private:
    ...
    static constexpr int  IDM_SVC_INSTALL   = 2010;
    static constexpr int  IDM_SVC_UNINSTALL = 2011;
    static constexpr int  IDM_SVC_START     = 2012;
    static constexpr int  IDM_SVC_STOP      = 2013;
    static constexpr int  IDM_SVC_RESTART   = 2014;
